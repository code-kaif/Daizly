    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
          ...
          <div className="flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full">
            {productData.image.map((item, index) => (
              <img
                ...
                src={item}
                key={index}
                className="w-[24%] sm:w-[90%] sm:mb-3 flex-shrink-0 cursor-pointer"
                alt=""
              />
            ))}
          </div>
        ...
        <div className="flex-1">
          ...
          <div
            className="my-3 text-gray-500 md:w-4/5 whitespace-pre-line"
          ...
          <button
            ...
            className="bg-gray-800 hover:bg-gray-900 text-white rounded-md px-8 py-2 my-4 text-sm active:bg-gray-700"
          >
            ADD TO CART
          </button>
